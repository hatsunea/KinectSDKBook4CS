...
Partial Public Class MainWindow
    ...
    Private Sub StartKinect(ByVal sensor As KinectSensor)
        ...
        Dim _thread As Thread = New Thread(
                                New ThreadStart(Sub()
                                                    ...
                                                    ' エコーのキャンセルと抑制を有効にする
                                                    Me.KinectEvents.AudioSource.EchoCancellationMode = EchoCancellationMode.CancellationAndSuppression
                                                    ' 音声の入力を開始する
                                                    Using _stream As Stream = Me.KinectEvents.AudioSource.Start()
                                                        Do While (IsContinue)
                                                            ' 音声を入力し、スピーカーに出力する
    ...
    ''' <remarks></remarks>
    Private Sub DrawSkeleton(sensor As KinectSensor, _skeletonFrame As SkeletonFrame)
        ' スケルトンのデータを取得する
