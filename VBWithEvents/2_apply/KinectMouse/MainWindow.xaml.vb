...
Class MainWindow
                ...
                If _skeletonFrame IsNot Nothing Then
                    ...
                    If (_skeleton IsNot Nothing) AndAlso (_skeleton.TrackingState = SkeletonTrackingState.Tracked) Then
                        ...
                        If hand.TrackingState = JointTrackingState.Tracked Then
                            ...
                            ' スケルトン座標 → RGB画像座標
                            Dim _point As ColorImagePoint = sensor.MapSkeletonPointToColor(hand.Position,
                            ...
                            _point.X = (_point.X * _screen.Bounds.Width) / sensor.ColorStream.FrameWidth
                            _point.Y = (_point.Y * _screen.Bounds.Height) / sensor.ColorStream.FrameHeight
    ...
    Private Sub StartKinect(ByVal sensor As KinectSensor)
        Try
            ...
            Me.KinectEvents.SkeletonStream.Enable(New TransformSmoothParameters With
                                             {
                                                 .Smoothing = 0.7F,
                                                 .Correction = 0.3F,
                                                 .Prediction = 0.4F,
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function IsClicked(_skeletonFrame As SkeletonFrame,
                               _point As ColorImagePoint) As Boolean
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function IsSteady(_skeletonFrame As SkeletonFrame,
                              _point As ColorImagePoint) As Boolean
    ...
    ''' <remarks></remarks>
    Private Sub DrawSkeletonPoint(_drawingContext As DrawingContext,
                                  _joint As Joint)
        ...
        ' 円を書く
        Dim _point As ColorImagePoint = Me.KinectEvents.MapSkeletonPointToColor(_joint.Position,
