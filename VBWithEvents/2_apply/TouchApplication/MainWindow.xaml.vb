...
Class MainWindow
    ...
    Private Sub StartKinect(ByVal sensor As KinectSensor)
        Try
            ...
            Me.KinectEvents.ColorStream.Enable(ColorImageFormat.RgbResolution640x480Fps30)
            Me.KinectEvents.DepthStream.Enable(DepthImageFormat.Resolution640x480Fps30)
    ...
    Private Sub Kinect_AllFramesReady(sender As Object,
                                      e As AllFramesReadyEventArgs) _
        ...
        Try
            Using colorFrame As ColorImageFrame = e.OpenColorImageFrame
                Using depthFrame As DepthImageFrame = e.OpenDepthImageFrame
                    If colorFrame IsNot Nothing AndAlso depthFrame IsNot Nothing AndAlso Me.KinectEvents.IsRunning Then
                        ...
                        Me.KinectEvents.MapDepthFrameToColorFrame(Me.KinectEvents.DepthStream.Format,
                                                            Me.DepthPixel,
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Private Function CoordinateColorImage(points As ColorImagePoint(),
                                          colorPixels As Byte()) As Byte()
        Dim colorStream As ColorImageStream = Me.KinectEvents.ColorStream
        ...
        For index As Integer = 0 To DepthPixel.Length - 1
            ...
            Dim colorIndex As Integer = ((y * KinectEvents.DepthStream.FrameWidth) + x) * Bgr32BytesPerPixel
    ...
    Private Sub SaveBackgroundDepth()
        Dim depthStream As DepthImageStream = Me.KinectEvents.DepthStream
