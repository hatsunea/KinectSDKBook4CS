...
Public Class PointCloudScene
    ...
    ''' <remarks></remarks>
    Public Sub StartKinect(sensor As KinectSensor)
        ...
        ' 変換のための基準値を設定
        Depth.FrameWidth = KinectEvents.DepthStream.FrameWidth
        Depth.FrameHeight = KinectEvents.DepthStream.FrameHeight
        Depth.MaxDepth = KinectEvents.DepthStream.MaxDepth
    End Sub
    ...
    ''' <param name="sensor"></param>
    ''' <remarks></remarks>
    Public Sub StopKinect(sensor As KinectSensor)
    ...
    Private Function GetPoint() As Boolean
        ...
        Using colorFrame As ColorImageFrame = sensor.ColorStream.OpenNextFrame(100)
            Using depthFrame As DepthImageFrame = sensor.DepthStream.OpenNextFrame(100)
