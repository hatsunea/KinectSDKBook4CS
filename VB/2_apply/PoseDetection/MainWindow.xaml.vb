...
Class MainWindow
        ...
        Try
            ...
            Using colorFrame As ColorImageFrame = e.OpenColorImageFrame
                If colorFrame IsNot Nothing Then
                    ...
                    ' ピクセルデータをビットマップに変換する
                    RGBCameraImage.Source = BitmapSource.Create(colorFrame.Width,
                                                                colorFrame.Height,
                                                                96,
                                                                96,
                                                                PixelFormats.Bgr32,
        ...
        Try
            ...
            Using _skeletionFrame As SkeletonFrame = e.OpenSkeletonFrame
                If _skeletionFrame IsNot Nothing Then
                    Call DrawCrossPoint(kinect, _skeletionFrame)
                End If
            End Using
        Catch ex As Exception
            MessageBox.Show(ex.Message)
    ...
    ''' <remarks></remarks>
    Private Sub DrawCrossPoint(kinect As KinectSensor,
        ...
        For i As Integer = 0 To 4 - 1
            jointImagePosition(i) = kinect.MapSkeletonPointToColor(joints(i).Position,
